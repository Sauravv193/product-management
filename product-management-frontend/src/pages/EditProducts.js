    ...
    return (
      <div className="min-h-screen flex items-center justify-center" style={{ background: 'linear-gradient(135deg, #f8fafc 0%, #f1f5f9 50%, #e2e8f0 100%)' }}>
        <div className="text-center">
          <LoadingSpinner size="xl" color="#3b82f6" />
      ...
      <div className="container">
        ...
        <div className="glass-card fade-in">
          <div className="flex justify-between items-center mb-8">
            <div>
              <h2 className="text-3xl font-bold" style={{ color: '#1e293b' }}>Edit Product</h2>
              <p className="text-gray-600 mt-2 font-medium">Update the details of "{product.name}"</p>
            </div>
            <button 
